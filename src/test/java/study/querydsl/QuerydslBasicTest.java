...
public class QuerydslBasicTest {
    ...
    public void search() {
        ...
        Member findMember = queryFactory.selectFrom(m)
                                        .where(m.username.eq("member1"), m.age.eq(10))  // .and() , .or()
                                        .fetchOne();
    ...
    public void subQuery() throws Exception {
        ...
        List<Member> result = queryFactory.selectFrom(member)
        .where(member.age.eq(
            select(memberSub.age.max()).from(memberSub)  // 서브 쿼리 예제
        ))
        .fetch();
    ...
    public void subQueryGoe() throws Exception {
        ...
        List<Member> result = queryFactory.selectFrom(member)
                .where(member.age.goe(
                    select(memberSub.age.avg()).from(memberSub) // 서브 쿼리 예제
                )).fetch();
    ...
    public void subQueryIn() throws Exception {
        ...
        List<Member> result = queryFactory.selectFrom(member)
                .where(member.age.in(
                    select(memberSub.age).from(memberSub).where(memberSub.age.gt(10)) // 서브 쿼리 예제
                )).fetch();
